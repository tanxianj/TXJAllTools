...
- (void)viewDidLoad
{
    ...
    UIButton *btn = [UIButton buttonWithTitle:@"这是个测试" buttonTitleFontSize:14.0 buttonTitleColor:[UIColor colorWithHexString:@"F85753"] buttonBgColor:nil buttonTextAlignment:NSTextAlignmentCenter];
